...
public class Parser {
	...
	void C() {
		while (false) {
			SynErr(15); // ANY node that matches no symbol
		}
		Get();
	}
	...
	bool[,] set = {
		...
		{_x,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x}
  ...
  public string errMsgFormat = "-- line {0} col {1}: {2}"; // 0=line, 1=column, 2=text
	...
	public void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 12: s = "invalid A"; break;
			case 13: s = "invalid B"; break;
			case 14: s = "invalid B"; break;
			case 15: s = "invalid C"; break;
			case 16: s = "invalid D"; break;
